import {
  ...
  export async function POST(
    ...
    try {
      ...
      /*
       * İmza ham istek gövdesi üzerinden
       * doğrulanmalıdır. JSON'a çevirmeden önce
       * request.text() ile alıyoruz.
       */
      ...
      if (
        ...
        /*
         * Tanımadığımız olayları tekrar
         * gönderilmemesi için başarılı kabul ediyoruz.
         */
        return NextResponse.json({
          received: true,
          ignored: true,
      ...
      if (
        ...
        /*
         * Aynı mağazadaki başka ürün veya varyantlara
         * ait olaylar bu uygulamayı etkilemez.
         */
        return NextResponse.json({
          received: true,
          ignored: true,
      ...
      /*
       * Lemon Squeezy iptal edilen aboneliği dönem
       * sonuna kadar geçerli tutar. Bu yüzden yalnızca
       * gerçekten expired olduğunda Free plana düşürürüz.
       */
      const isExpired =
        eventName ===
          "subscription_expired" ||
      ...
      batch.set(
        accountReference,
        {
          ...
          /*
           * Kullanıcı ücretli Pro'ya geçtiğinde
           * uygulama içi deneme artık kullanılmaz.
           */
          trialEndsAt: null,
